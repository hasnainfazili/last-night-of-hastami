	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float temp_output_155_0_g963 = saturate( ( ( distance( WorldPosition2_g963 , _WorldSpaceCameraPos ) - temp_output_7_0_g975 ) / ( AHF_FogDistanceEnd - temp_output_7_0_g975 ) ) );
				#ifdef AHF_DISABLE_FALLOFF
				float staticSwitch467_g963 = temp_output_155_0_g963;
				#else
				float staticSwitch467_g963 = pow( abs( temp_output_155_0_g963 ) , AHF_FogDistanceFalloff );
				#endif
				half FogDistanceMask12_g963 = staticSwitch467_g963;
				...
				float temp_output_140_0_g963 = ( (dotResult145_g963*0.5 + 0.5) * AHF_DirectionalIntensity );
				#ifdef AHF_DISABLE_FALLOFF
				float staticSwitch470_g963 = temp_output_140_0_g963;
				#else
				float staticSwitch470_g963 = pow( abs( temp_output_140_0_g963 ) , AHF_DirectionalFalloff );
				#endif
				float DirectionalMask30_g963 = staticSwitch470_g963;
				...
				#endif
				float3 temp_output_2_0_g974 = staticSwitch442_g963;
				...
				#endif
				half3 Final_Color462_g963 = staticSwitch1_g974;
				...
				float temp_output_167_0_g963 = saturate( ( ( ( break159_g963.x + break159_g963.y + break159_g963.z ) - temp_output_7_0_g976 ) / ( AHF_FogHeightStart - temp_output_7_0_g976 ) ) );
				#ifdef AHF_DISABLE_FALLOFF
				float staticSwitch468_g963 = temp_output_167_0_g963;
				#else
				float staticSwitch468_g963 = pow( abs( temp_output_167_0_g963 ) , AHF_FogHeightFalloff );
				#endif
				half FogHeightMask16_g963 = staticSwitch468_g963;
				...
				float3 p1_g977 = temp_output_197_0_g963;
				float localSimpleNoise3D1_g977 = SimpleNoise3D( p1_g977 );
				float temp_output_7_0_g979 = AHF_NoiseDistanceEnd;
				half NoiseDistanceMask7_g963 = saturate( ( ( distance( WorldPosition2_g963 , _WorldSpaceCameraPos ) - temp_output_7_0_g979 ) / ( 0.0 - temp_output_7_0_g979 ) ) );
				float lerpResult198_g963 = lerp( 1.0 , (localSimpleNoise3D1_g977*0.5 + 0.5) , ( NoiseDistanceMask7_g963 * AHF_NoiseIntensity ));
				...
				#endif
				float temp_output_454_0_g963 = ( staticSwitch42_g963 * AHF_FogIntensity );
				...
				float temp_output_449_0_g963 = ( ( break170_g963.x + break170_g963.y + break170_g963.z ) + -AHF_SkyboxFogOffset );
				float temp_output_7_0_g978 = AHF_SkyboxFogHeight;
				float temp_output_176_0_g963 = saturate( ( ( abs( temp_output_449_0_g963 ) - temp_output_7_0_g978 ) / ( 0.0 - temp_output_7_0_g978 ) ) );
				float saferPower309_g963 = abs( temp_output_176_0_g963 );
				#ifdef AHF_DISABLE_FALLOFF
				float staticSwitch469_g963 = temp_output_176_0_g963;
				#else
				float staticSwitch469_g963 = pow( saferPower309_g963 , AHF_SkyboxFogFalloff );
				#endif
				float lerpResult179_g963 = lerp( saturate( ( staticSwitch469_g963 + ( AHF_SkyboxFogBottom * step( temp_output_449_0_g963 , 0.0 ) ) ) ) , 1.0 , AHF_SkyboxFogFill);
				...
				#endif
				half SkyboxFogMask95_g963 = ( 1.0 - ceil( staticSwitch123_g963 ) );
				float lerpResult112_g963 = lerp( temp_output_454_0_g963 , SkyboxFogHeightMask108_g963 , SkyboxFogMask95_g963);
				#ifdef AHF_DISABLE_SKYBOXFOG
				float staticSwitch455_g963 = temp_output_454_0_g963;
				#else
				float staticSwitch455_g963 = lerpResult112_g963;
				#endif
				half Final_Alpha463_g963 = staticSwitch455_g963;
				float4 appendResult114_g963 = (float4(Final_Color462_g963 , Final_Alpha463_g963));
				float4 appendResult457_g963 = (float4(WorldPosition2_g963 , 1.0));
				#ifdef AHF_DEBUG_WORLDPOS
				float4 staticSwitch456_g963 = appendResult457_g963;
				#else
				float4 staticSwitch456_g963 = appendResult114_g963;
				#endif
				
				surfaceDescription.Color = (staticSwitch456_g963).xyz;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = (staticSwitch456_g963).w;
...
/*ASEBEGIN
Version=18934
1920;0;1920;1029;4066.594;5114.538;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;1077;-3328,-4608;Inherit;False;Base;0;;963;13c50910e5b86de4097e1181ba121e0e;28,347,0,386,0,370,0,388,0,378,0,384,0,339,0,382,0,380,0,355,0,392,0,376,0,366,0,116,1,343,0,354,0,99,1,360,0,364,0,450,0,368,0,345,0,349,0,351,0,361,0,476,0,372,0,374,0;0;3;FLOAT4;113;FLOAT3;86;FLOAT;87
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1058;-3072,-4608;Float;False;True;-1;2;HeightFogShaderGUI;0;17;Hidden/BOXOPHOBIC/Atmospherics/Height Fog Global;7f5cb9c3ea6481f469fdd856555439ef;True;Forward Unlit;0;0;Forward Unlit;9;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;True;2;5;False;-20;10;False;-21;0;5;False;-22;10;False;-23;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;-26;False;False;False;False;False;False;False;False;False;True;False;0;True;-5;255;False;-1;255;True;-6;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-24;True;7;False;-32;False;True;1;LightMode=ForwardOnly;False;False;3;Include;;False;;Native;Custom;#define _SURFACE_TYPE_TRANSPARENT;False;;Custom;Custom;#define _BLENDMODE_ALPHA;False;;Custom;Hidden/InternalErrorShader;0;0;Standard;29;Surface Type;1;0;  Rendering Pass ;0;0;  Rendering Pass;1;0;  Blending Mode;0;0;  Receive Fog;0;0;  Distortion;0;0;    Distortion Mode;0;0;    Distortion Only;1;0;  Depth Write;0;0;  Cull Mode;1;0;  Depth Test;8;0;Double-Sided;0;0;Alpha Clipping;0;0;Motion Vectors;0;0;  Add Precomputed Velocity;0;0;Shadow Matte;0;0;Cast Shadows;0;0;DOTS Instancing;0;0;GPU Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;7;True;False;False;False;False;False;False;False;;False;0
...
ASEEND*/
//CHKSM=71B59E02AB2E1BCE976DDD5BDEF5189E859AF98B