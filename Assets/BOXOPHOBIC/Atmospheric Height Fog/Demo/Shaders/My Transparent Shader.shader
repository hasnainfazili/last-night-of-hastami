	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				#endif
				float3 vertexValue = ( ( simplePerlin3D27 * _VertexIntensity ) * inputMesh.normalOS );
				#ifdef ASE_ABSOLUTE_VERTEX_POS
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				half FogDistanceMask12_g914 = pow( abs( saturate( ( ( distance( WorldPosition2_g914 , _WorldSpaceCameraPos ) - temp_output_7_0_g933 ) / ( AHF_FogDistanceEnd - temp_output_7_0_g933 ) ) ) ) , AHF_FogDistanceFalloff );
				...
				#endif
				float3 temp_output_2_0_g932 = staticSwitch442_g914;
				...
				#endif
				float3 temp_output_256_0_g914 = staticSwitch1_g932;
				...
				half FogHeightMask16_g914 = pow( abs( saturate( ( ( ( break159_g914.x + break159_g914.y + break159_g914.z ) - temp_output_7_0_g935 ) / ( AHF_FogHeightStart - temp_output_7_0_g935 ) ) ) ) , AHF_FogHeightFalloff );
				...
				float3 p1_g936 = temp_output_197_0_g914;
				float localSimpleNoise3D1_g936 = SimpleNoise3D( p1_g936 );
				float temp_output_7_0_g934 = AHF_NoiseDistanceEnd;
				half NoiseDistanceMask7_g914 = saturate( ( ( distance( WorldPosition2_g914 , _WorldSpaceCameraPos ) - temp_output_7_0_g934 ) / ( 0.0 - temp_output_7_0_g934 ) ) );
				float lerpResult198_g914 = lerp( 1.0 , (localSimpleNoise3D1_g936*0.5 + 0.5) , ( NoiseDistanceMask7_g914 * AHF_NoiseIntensity ));
				...
				float3 lerpResult82_g904 = lerp( _Color.rgb , temp_output_95_86_g904 , temp_output_95_87_g904);
				
				float3 ase_worldNormal = packedInput.ase_texcoord1.xyz;
				float fresnelNdotV79 = dot( ase_worldNormal, V );
				float fresnelNode79 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV79, 5.0 ) );
				
				surfaceDescription.Color = lerpResult82_g904;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = saturate( ( 1.0 - fresnelNode79 ) );
...
/*ASEBEGIN
Version=18803
1920;0;1920;1029;-800.8967;-674.4473;1;True;False
Node;AmplifyShaderEditor.Vector3Node;30;-512,2048;Half;False;Property;_NoiseSpeed;Noise Speed;34;0;Create;True;0;0;0;False;0;False;0.5,0.5,0;1,1,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;32;-512,1824;Half;False;Property;_NoiseScale;Noise Scale;33;0;Create;True;0;0;0;False;0;False;6;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;39;-512,1664;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.NegateNode;36;-320,2048;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleTimeNode;31;-512,2208;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;35;-192,1728;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;37;-192,2048;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleAddOpNode;33;0,1920;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;50;0,1728;Inherit;False;Property;_VertexIntensity;Vertex Intensity;35;0;Create;True;0;0;0;False;0;False;0;0.03;0;0.2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.NoiseGeneratorNode;27;128,1920;Inherit;False;Simplex3D;False;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;85;1152,896;Inherit;False;Apply Height Fog;0;;904;950890317d4f36a48a68d150cdab0168;0;1;81;FLOAT3;0,0,0;False;3;FLOAT3;85;FLOAT3;86;FLOAT;87
Node;AmplifyShaderEditor.ColorNode;5;768,896;Inherit;False;Property;_Color;Color;32;1;[HDR];Create;True;0;0;0;False;0;False;1,0,0,0;0.6415094,0.006621321,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;85;81;5;0
WireConnection;48;0;45;0
WireConnection;48;1;49;0
WireConnection;81;0;80;0
WireConnection;97;0;85;85
WireConnection;97;2;81;0
WireConnection;97;6;48;0
ASEEND*/
//CHKSM=05F2ED9AD4E8275A8081F292AF766C40C96F614C